class CheckBox < Gui
  ...
  def calculate_responsivity
    ...
    @font_solid = LoadFontEx("Client/resources/fonts/fa_font_solid.otf", @check_size, @simbols, 2)
    @font_line = LoadFontEx("Client/resources/fonts/fa_font.otf", @check_size, @simbols, 2)
  end
